    ...
    if uploaded_file:
        ...
        if "text" in df.columns:
            ...
            if st.button("Process CSV"):
                ...
                st.download_button("Download JSON", json_data, "grade_responses_lama3_p4.json", "application/json")
                
                # Provide download button for the response as CSV file
                st.download_button("Download CSV", response_df.to_csv(index=False), "grade_responses_lama3_p3grade_lama3_p4.py.csv", "text/csv")
        else:
