    ...
    if uploaded_file:
        ...
        if "text" in df.columns:
            ...
            if st.button("Process CSV"):
                ...
                st.download_button("Download JSON", json_data, "morph_responses_lama3_p3.json", "application/json")
                
                # Provide download button for the response as CSV file
                st.download_button("Download CSV", response_df.to_csv(index=False), "morph_responses_lama3_p3.csv", "text/csv")
        else:
