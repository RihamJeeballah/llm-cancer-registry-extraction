    ...
    if uploaded_file:
        ...
        if "text" in df.columns:
            ...
            if st.button("Process CSV"):
                ...
                st.download_button("Download JSON", json_data, "treat_responses_qwen_p1.json", "application/json")
                
                # Provide download button for the response as CSV file
                st.download_button("Download CSV", response_df.to_csv(index=False), "treat_responses_qwen_p1.csv", "text/csv")
        else:
